...
def call(String buildResult,String stageName) {
  if ( buildResult == "SUCCESS" ) {
    slackSend channel: 'devops',color: 'good', message: "stageName within ${JOB_NAME} with buildnumber ${BUILD_NUMBER} has completed, check ${BUILD_URL}", teamDomain: 'projectdevops', tokenCredentialId: 'Slackcred'
  }
